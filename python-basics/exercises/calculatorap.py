# Calculator with argparse

# Aufgabe: Erstellen Sie ein Skript, das einfache mathematische Operationen basierend 
# auf Befehlszeilenargumenten durchführt.
...
#    - Bei der Division soll eine Fehlerbehandlung implementiert werden, 
